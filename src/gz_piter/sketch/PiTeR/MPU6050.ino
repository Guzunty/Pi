 ...
 * MPU6050.ino
 *
 * Pi Terrestrial Robot - IMU driver
 * 
 ...
 * MA 02110-1301, USA.
 * 
 * This module provide the access routines for setting up and reading
 * the MPU6050 Inertial Measurement Unit (IMU).
 * 
 */
...
int MPU6050_setup() {
  ...
  TWBR = ((CPU_FREQ / MAX_I2C_RATE) - 16) / 2; // Run I2C at 400 KHz
  ...
  MPU6050_write_reg (MPU6050_SMPLRT_DIV, 0x01);
